...
pkgdatadir = $(datadir)/mutx
pkgincludedir = $(includedir)/mutx
pkglibdir = $(libdir)/mutx
pkglibexecdir = $(libexecdir)/mutx
...
CONFIG_HEADER = $(top_builddir)/src/config/mutx-config.h
...
am__DIST_COMMON = $(srcdir)/Makefile.in \
	...
	$(top_srcdir)/src/config/mutx-config.h.in \
...
ACLOCAL = ${SHELL} /Users/martinmizzell/repos/mutx/build-aux/missing aclocal-1.16
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AR = /usr/bin/ar
AUTOCONF = ${SHELL} /Users/martinmizzell/repos/mutx/build-aux/missing autoconf
AUTOHEADER = ${SHELL} /Users/martinmizzell/repos/mutx/build-aux/missing autoheader
AUTOMAKE = ${SHELL} /Users/martinmizzell/repos/mutx/build-aux/missing automake-1.16
AWK = awk
BDB_CPPFLAGS = 
BDB_LIBS = -ldb_cxx-4.8
BITCOIN_CLI_NAME = mutx-cli
BITCOIN_DAEMON_NAME = mutxd
BITCOIN_GUI_NAME = mutx-qt
BITCOIN_TX_NAME = mutx-tx
...
CPPFLAGS = -I/usr/local/opt/openssl/include -I/usr/local/opt/boost@1.60/include -I/usr/local/opt/icu4c/include -DBOOST_SPIRIT_THREADSAFE -DHAVE_BUILD_INFO -D__STDC_FORMAT_MACROS -I/usr/local/opt/berkeley-db@4/include -DMAC_OSX  -U_FORTIFY_SOURCE -D_FORTIFY_SOURCE=2 -DHAVE_QT5
CRYPTO_CFLAGS = -I/usr/local/Cellar/openssl/1.0.2o_1/include
CRYPTO_LIBS = -L/usr/local/Cellar/openssl/1.0.2o_1/lib -lcrypto
CXX = g++ -std=c++11
CXXCPP = g++ -std=c++11 -E
CXXDEPMODE = depmode=gcc3
CXXFLAGS = -g3 -O0 -DDEBUG -Wall -Wextra -Wformat -Wformat-security -Wno-unused-parameter  -Wstack-protector -fstack-protector-all -fPIC -fvisibility=hidden
CYGPATH_W = echo
DEFS = -DHAVE_CONFIG_H
DEPDIR = .deps
DLLTOOL = false
...
LDFLAGS = -L/usr/local/opt/openssl/lib -L/usr/local/opt/boost@1.60/lib -L/usr/local/opt/icu4c/lib -Wl,-headerpad_max_install_names  -Wl,-dead_strip
LEVELDB_CPPFLAGS = 
...
MAINT = 
MAKEINFO = ${SHELL} /Users/martinmizzell/repos/mutx/build-aux/missing makeinfo
MAKENSIS = 
MANIFEST_TOOL = :
MINIUPNPC_CPPFLAGS = 
...
OBJCXXFLAGS = -g3 -O0 -DDEBUG -Wall -Wextra -Wformat -Wformat-security -Wno-unused-parameter  -Wstack-protector -fstack-protector-all -fPIC
OBJDUMP = objdump
OBJEXT = o
OTOOL = otool
OTOOL64 = :
PACKAGE = mutx
PACKAGE_BUGREPORT = www.mutx.org
PACKAGE_NAME = Mutex Core
PACKAGE_STRING = Mutex Core 4.0.0
PACKAGE_TARNAME = mutx
PACKAGE_URL = 
PACKAGE_VERSION = 4.0.0
PATH_SEPARATOR = :
PKG_CONFIG = /usr/local/bin/pkg-config
PKG_CONFIG_LIBDIR = 
PKG_CONFIG_PATH = /usr/local/opt/qt/lib/pkgconfig:/usr/local/opt/openssl/lib/pkgconfig:/usr/local/opt/openssl/lib/pkgconfig /usr/local/opt/boost@1.60/lib/pkconfig /usr/local/opt/icu4c/lib/pkgconfig
PORT = 
...
abs_builddir = /Users/martinmizzell/repos/mutx
abs_srcdir = /Users/martinmizzell/repos/mutx
abs_top_builddir = /Users/martinmizzell/repos/mutx
abs_top_srcdir = /Users/martinmizzell/repos/mutx
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /Users/martinmizzell/repos/mutx/build-aux/install-sh
...
COVERAGE_INFO = baseline_filtered_combined.info baseline.info block_test.info \
  leveldb_baseline.info test_mutx_filtered.info total_coverage.info \
  baseline_filtered.info block_test_filtered.info \
  leveldb_baseline_filtered.info test_mutx_coverage.info test_mutx.info

OSX_APP_BUILT = $(OSX_APP)/Contents/PkgInfo $(OSX_APP)/Contents/Resources/empty.lproj \
  $(OSX_APP)/Contents/Resources/bitcoin.icns $(OSX_APP)/Contents/Info.plist \
  $(OSX_APP)/Contents/MacOS/RUPAYA-Qt $(OSX_APP)/Contents/Resources/Base.lproj/InfoPlist.strings
...
src/config/mutx-config.h: src/config/stamp-h1
	@test -f $@ || rm -f src/config/stamp-h1
	@test -f $@ || $(MAKE) $(AM_MAKEFLAGS) src/config/stamp-h1

src/config/stamp-h1: $(top_srcdir)/src/config/mutx-config.h.in $(top_builddir)/config.status
	@rm -f src/config/stamp-h1
	cd $(top_builddir) && $(SHELL) ./config.status src/config/mutx-config.h
$(top_srcdir)/src/config/mutx-config.h.in:  $(am__configure_deps) 
	($(am__cd) $(top_srcdir) && $(AUTOHEADER))
	rm -f src/config/stamp-h1
	touch $@

distclean-hdr:
	-rm -f src/config/mutx-config.h src/config/stamp-h1
...
$(OSX_APP)/Contents/MacOS/RUPAYA-Qt: $(BITCOIN_QT_BIN)
	$(MKDIR_P) $(@D)
...
#$(APP_DIST_EXTRAS): $(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/RUPAYA-Qt
...
#$(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/RUPAYA-Qt: $(OSX_APP_BUILT) $(OSX_PACKAGING)
...
#test_mutx.info: baseline_filtered_combined.info
#	$(MAKE) -C src/ check
#	$(LCOV) -c -d $(abs_builddir)/src -t test_mutx -o $@
#	$(LCOV) -z -d $(abs_builddir)/src
#	$(LCOV) -z -d $(abs_builddir)/src/leveldb

#test_mutx_filtered.info: test_mutx.info
#	$(LCOV) -r $< "/usr/include/*" -o $@

#block_test.info: test_mutx_filtered.info
#	$(MKDIR_P) qa/tmp
...
#test_mutx_coverage.info: baseline_filtered_combined.info test_mutx_filtered.info
#	$(LCOV) -a baseline_filtered.info -a leveldb_baseline_filtered.info -a test_mutx_filtered.info -o $@

#total_coverage.info:  baseline_filtered_combined.info test_mutx_filtered.info block_test_filtered.info
#	$(LCOV) -a baseline_filtered.info -a leveldb_baseline_filtered.info -a test_mutx_filtered.info -a block_test_filtered.info -o $@ | $(GREP) "\%" | $(AWK) '{ print substr($$3,2,50) "/" $$5 }' > coverage_percent.txt

#test_mutx.coverage/.dirstamp:  test_mutx_coverage.info
#	$(GENHTML) -s $< -o $(@D)
#	@touch $@
...
#cov: test_mutx.coverage/.dirstamp total.coverage/.dirstamp

.INTERMEDIATE: $(COVERAGE_INFO)

clean-local:
	rm -rf test_mutx.coverage/ total.coverage/ $(OSX_APP)
