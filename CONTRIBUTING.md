Contributing to Mutex Core
============================

The Mutex Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Mutex Core project, and is not to be
confused with overall Mutx Network Protocol consensus changes.

Whether a pull request is merged into Mutex Core rests with the project merge
...
The project leader is the release manager for each Mutex Core release.
