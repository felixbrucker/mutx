...
public:
    ...
    void setupUi(QDialog *SendCoinsDialog)
    {
        ...
        labelCoinControlAfterFee->setText(QStringLiteral("0.00 MUTX"));
        ...
        labelCoinControlChange->setText(QStringLiteral("0.00 MUTX"));
        ...
        checkzMUTX = new QCheckBox(SendCoinsDialog);
        checkzMUTX->setObjectName(QStringLiteral("checkzMUTX"));
        checkzMUTX->setEnabled(false);

        horizontalLayout_2->addWidget(checkzMUTX);
        ...
        labelBalance->setText(QStringLiteral("123.456 MUTX"));
    ...
    void retranslateUi(QDialog *SendCoinsDialog)
    {
        ...
        labelBlockSize->setText(QApplication::translate("SendCoinsDialog", "0 MUTX", nullptr));
...
#ifndef QT_NO_TOOLTIP
        radioCustomPerKilobyte->setToolTip(QApplication::translate("SendCoinsDialog", "If the custom fee is set to 1000 uMUTXs and the transaction is only 250 bytes, then \"per kilobyte\" only pays 250 uMUTXs in fee,<br />while \"at least\" pays 1000 uMUTXs. For transactions bigger than a kilobyte both pay by kilobyte.", nullptr));
#endif // QT_NO_TOOLTIP
        radioCustomPerKilobyte->setText(QApplication::translate("SendCoinsDialog", "per kilobyte", nullptr));
#ifndef QT_NO_TOOLTIP
        radioCustomAtLeast->setToolTip(QApplication::translate("SendCoinsDialog", "If the custom fee is set to 1000 uMUTXs and the transaction is only 250 bytes, then \"per kilobyte\" only pays 250 uMUTXs in fee,<br />while \"total at least\" pays 1000 uMUTXs. For transactions bigger than a kilobyte both pay by kilobyte.", nullptr));
#endif // QT_NO_TOOLTIP
        radioCustomAtLeast->setText(QApplication::translate("SendCoinsDialog", "total at least", nullptr));
#ifndef QT_NO_TOOLTIP
        checkBoxMinimumFee->setToolTip(QApplication::translate("SendCoinsDialog", "Paying only the minimum fee is just fine as long as there is less transaction volume than space in the blocks.<br />But be aware that this can end up in a never confirming transaction once there is more demand for Mutx transactions than the network can process.", nullptr));
#endif // QT_NO_TOOLTIP
        checkBoxMinimumFee->setText(QString());
#ifndef QT_NO_TOOLTIP
        labelMinFeeWarning->setToolTip(QApplication::translate("SendCoinsDialog", "Paying only the minimum fee is just fine as long as there is less transaction volume than space in the blocks.<br />But be aware that this can end up in a never confirming transaction once there is more demand for Mutx transactions than the network can process.", nullptr));
#endif // QT_NO_TOOLTIP
        ...
        checkzMUTX->setText(QApplication::translate("SendCoinsDialog", "Anonymized MUTX", nullptr));
