...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        {"mutx", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"mutx", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use mutxd, or the -server option to mutx-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
