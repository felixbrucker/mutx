...
#ifndef QT_NO_TOOLTIP
        radioCustomPerKilobyte->setToolTip(QApplication::translate("SendCoinsDialog", "If the custom fee is set to 1000 uRUPs and the transaction is only 250 bytes, then \"per kilobyte\" only pays 250 uRUPs in fee,<br />while \"at least\" pays 1000 uRUPs. For transactions bigger than a kilobyte both pay by kilobyte.", nullptr));
#endif // QT_NO_TOOLTIP
        radioCustomPerKilobyte->setText(QApplication::translate("SendCoinsDialog", "per kilobyte", nullptr));
#ifndef QT_NO_TOOLTIP
        radioCustomAtLeast->setToolTip(QApplication::translate("SendCoinsDialog", "If the custom fee is set to 1000 uRUPs and the transaction is only 250 bytes, then \"per kilobyte\" only pays 250 uRUPs in fee,<br />while \"total at least\" pays 1000 uRUPs. For transactions bigger than a kilobyte both pay by kilobyte.", nullptr));
#endif // QT_NO_TOOLTIP
