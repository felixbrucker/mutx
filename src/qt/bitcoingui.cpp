                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Mutex Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zMUTX"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Mutex Core"), this);
    aboutAction->setStatusTip(tr("Show information about Mutex Core"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the Mutex Core help message to get a list with possible Mutx command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Mutex Core client") + " " + networkStyle->getTitleAddText();
...
{
    QString strTitle = tr("Mutex Core"); // default title
